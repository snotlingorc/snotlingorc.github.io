...
# Add in the javascript that will change the careers
    include_once "javascript/Kislev.php";
...
echo ""
  ...
  . "...For this is Kislev!<p>"
                                                                                                   
  . "<form method=POST action=generate.php> "
  . "<input type=hidden name=Location value=\"Kislev\">"
  . "<table border=0><tr>"
  ...
  echo "<OPTION VALUE=\"-1\">Select Tribe " ;
  echo "<option VALUE=\"Gospodar\"> Gospodar";
  echo "<option VALUE=\"Ungol\"> Ungol";

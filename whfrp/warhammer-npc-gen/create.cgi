...
# Copyright 1997 Mathew Anderson mathewa@monkeybutts.net  #
# Created : 10/26/1997           Last Modified 10/18/1997 #
# A MonkeyButts Production                                #
#   http://www.monkeybutts.net                            #
###########################################################      
...
###########################################################
# This is the section that you should change.
# Please make sure all the information is correct
###########################################################

$dir_location = "/home/snotling/httpd/modules/warhammer-npc-gen";
$host_name = "www.snotling.org";
$web_loc = "modules/warhammer-npc-gen";
$name = "create.cgi";
...
print "<a href=mailto:snotling\@snotling.org>snotling\@snotling.org</a>\n";
print "<p>\n <p>\n<center>";
print "<font size=2>Created by wh-npc v1.0\n<br>\n";
print "Warhammer and other Warhammer Fantasy Rople Play (and the Logo's) are (probably registered) trademarks of Games Workshop and/or HogsHead.  The use of trademarks and materials are not meant as a challange to their rights and is not intended to make or lose any money for anyone. \n";
print "</font></center>\n";
...
&career;
&skill;
# lets get the career information
